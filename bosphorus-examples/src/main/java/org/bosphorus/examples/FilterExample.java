...
public class FilterExample {
	public static void main(String[] args) throws Exception {
		...
		IPipeExecutor<List<Object>> executor = 
				ss.filter(ss.equals(ss.stringField("City"), "Ýstanbul"))
				.then(ss.consoleLog())
				.build();
		
		executor.writeOne(Arrays.asList(1, "Ýstanbul", 100));
		executor.writeOne(Arrays.asList(1, "Ýstanbul", 110));
		executor.writeOne(Arrays.asList(2, "Ankara", 95));
		executor.writeOne(Arrays.asList(1, "Ýstanbul", 125));
