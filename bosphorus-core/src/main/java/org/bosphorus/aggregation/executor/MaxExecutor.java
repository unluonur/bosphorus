...
public class MaxExecutor<TInput, TOutput extends Comparable<TOutput>> implements IAggregationExecutor<TInput, TOutput> {
	private IExpression<TInput, TOutput> expression;
	private TOutput value;
	
	public MaxExecutor(IExpression<TInput, TOutput> expression) {
