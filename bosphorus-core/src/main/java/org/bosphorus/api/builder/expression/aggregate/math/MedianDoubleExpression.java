...
import org.bosphorus.core.expression.aggregate.factory.math.MedianDoubleFactory;

public class MedianDoubleExpression implements IAggregateExpression<Number, Double> {
	...
	public IAggregateExecutorFactory<Number, Double> build() {
		return new MedianDoubleFactory();
	}
