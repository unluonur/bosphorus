...
import org.bosphorus.core.expression.aggregate.factory.math.MedianIntegerFactory;

public class MedianIntegerExpression implements IAggregateExpression<Number, Integer> {
	...
	public IAggregateExecutorFactory<Number, Integer> build() {
		return new MedianIntegerFactory();
	}
