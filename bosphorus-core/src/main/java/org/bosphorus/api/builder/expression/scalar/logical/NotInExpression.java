...
import org.bosphorus.core.expression.scalar.factory.logical.NotInExecutorFactory;

public class NotInExpression<TInput, TType extends Comparable<TType>> implements IScalarExpression2<TType, List<TType>, Boolean> {
	...
	public IScalarExecutorFactory2<TType, List<TType>, Boolean> build() {
		return new NotInExecutorFactory<TType>();
	}
