...
import org.bosphorus.core.expression.scalar.factory.logical.LessThanExecutorFactory;

public class LessThanExpression<TType extends Comparable<TType>> implements IScalarExpression2<TType, TType, Boolean> {

	private static final long serialVersionUID = 1L;

	@Override
	public IScalarExecutorFactory2<TType, TType, Boolean> build() {
		return new LessThanExecutorFactory<TType>();
	}
