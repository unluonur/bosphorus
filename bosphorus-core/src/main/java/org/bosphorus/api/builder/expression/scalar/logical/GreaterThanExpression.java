...
import org.bosphorus.core.expression.scalar.factory.logical.GreaterThanExecutorFactory;

public class GreaterThanExpression<TType extends Comparable<TType>> implements IScalarExpression2<TType, TType, Boolean> {

	private static final long serialVersionUID = 1L;

	@Override
	public IScalarExecutorFactory2<TType, TType, Boolean> build() {
		return new GreaterThanExecutorFactory<TType>();
	}
