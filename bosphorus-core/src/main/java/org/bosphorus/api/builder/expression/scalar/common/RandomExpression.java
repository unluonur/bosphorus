...
import org.bosphorus.core.expression.scalar.factory.common.RandomExecutorFactory;

public class RandomExpression implements IScalarExpression0<Double> {
	...
	public IScalarExecutorFactory0<Double> build() {
		return new RandomExecutorFactory();
	}
