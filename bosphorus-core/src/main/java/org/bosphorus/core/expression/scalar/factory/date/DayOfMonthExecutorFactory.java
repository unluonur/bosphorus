...
import org.bosphorus.core.expression.scalar.executor.date.DayOfMonthExecutor;
import org.bosphorus.core.expression.scalar.factory.IScalarExecutorFactory1;

public class DayOfMonthExecutorFactory implements IScalarExecutorFactory1<Date, Integer> {
	private static DayOfMonthExecutor instance = new DayOfMonthExecutor();
