...
import org.bosphorus.core.expression.scalar.executor.math.SubtractLongExecutor;
import org.bosphorus.core.expression.scalar.factory.IScalarExecutorFactory2;

public class SubtractLongExecutorFactory implements IScalarExecutorFactory2<Number, Number, Long> {
	private static SubtractLongExecutor instance = new SubtractLongExecutor();
