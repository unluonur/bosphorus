...
import org.bosphorus.core.expression.scalar.executor.event.ExpressionExecutor2;
...
public class ExpressionExecutorFactory2<TInput, TOutput, TType1, TType2> implements IScalarExecutorFactory1<TInput, TOutput> {
	private IScalarExecutorFactory2<? super TType1, ? super TType2, ? extends TOutput> executor;
	...
	public ExpressionExecutorFactory2(
			IScalarExecutorFactory2<? super TType1, ? super TType2, ? extends TOutput> executor, 
