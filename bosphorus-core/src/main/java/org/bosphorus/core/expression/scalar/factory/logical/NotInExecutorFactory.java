...
import org.bosphorus.core.expression.scalar.executor.logical.NotInExecutor;
import org.bosphorus.core.expression.scalar.factory.IScalarExecutorFactory2;

public class NotInExecutorFactory<TType extends Comparable<TType>> implements IScalarExecutorFactory2<TType, List<TType>, Boolean> {
	private NotInExecutor<TType> instance = new NotInExecutor<TType>();
