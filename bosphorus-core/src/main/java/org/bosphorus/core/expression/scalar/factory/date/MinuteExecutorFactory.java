...
import org.bosphorus.core.expression.scalar.executor.date.MinuteExecutor;
import org.bosphorus.core.expression.scalar.factory.IScalarExecutorFactory1;

public class MinuteExecutorFactory implements IScalarExecutorFactory1<Date, Integer> {
	private static MinuteExecutor instance = new MinuteExecutor();
