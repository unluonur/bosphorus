...
import org.bosphorus.core.expression.scalar.executor.math.AddFloatExecutor;
import org.bosphorus.core.expression.scalar.factory.IScalarExecutorFactory2;

public class AddFloatExecutorFactory implements IScalarExecutorFactory2<Number, Number, Float> {
	private static AddFloatExecutor instance = new AddFloatExecutor();
