...
import org.bosphorus.core.expression.scalar.executor.math.ModLongExecutor;
import org.bosphorus.core.expression.scalar.factory.IScalarExecutorFactory2;

public class ModLongExecutorFactory implements IScalarExecutorFactory2<Number, Number, Long> {
	private static ModLongExecutor instance = new ModLongExecutor();
