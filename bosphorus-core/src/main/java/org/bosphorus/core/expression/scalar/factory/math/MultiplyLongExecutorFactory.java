...
import org.bosphorus.core.expression.scalar.executor.math.MultiplyLongExecutor;
import org.bosphorus.core.expression.scalar.factory.IScalarExecutorFactory2;

public class MultiplyLongExecutorFactory implements IScalarExecutorFactory2<Number, Number, Long> {
	private static MultiplyLongExecutor instance = new MultiplyLongExecutor();
