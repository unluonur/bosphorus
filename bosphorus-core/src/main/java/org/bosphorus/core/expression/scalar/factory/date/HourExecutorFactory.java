...
import org.bosphorus.core.expression.scalar.executor.date.HourExecutor;
import org.bosphorus.core.expression.scalar.factory.IScalarExecutorFactory1;

public class HourExecutorFactory implements IScalarExecutorFactory1<Date, Integer> {
	private static HourExecutor instance = new HourExecutor();
