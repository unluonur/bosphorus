...
import org.bosphorus.core.expression.aggregate.executor.common.FirstExecutor;
import org.bosphorus.core.expression.aggregate.factory.IAggregateExecutorFactory;

public class FirstFactory<TType> implements IAggregateExecutorFactory<TType, TType> {

	@Override
	public IAggregateExecutor<TType, TType> create() {
		return new FirstExecutor<TType>();
	}
