...
import org.bosphorus.core.expression.scalar.executor.date.YearExecutor;
import org.bosphorus.core.expression.scalar.factory.IScalarExecutorFactory1;

public class YearExecutorFactory implements IScalarExecutorFactory1<Date, Integer> {
	private static YearExecutor instance = new YearExecutor();
