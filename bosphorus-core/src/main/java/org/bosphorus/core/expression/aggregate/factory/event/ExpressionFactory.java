...
import org.bosphorus.core.expression.aggregate.executor.event.ExpressionExecutor;
...
public class ExpressionFactory<TInput, TType, TOutput> implements IAggregateExecutorFactory<TInput, TOutput> {
	...
	private IScalarExecutorFactory1<? super TInput, ? extends TType> expression;
	private IAggregateExecutorFactory<? super TType, ? extends TOutput> factory;
	
	public ExpressionFactory(IScalarExecutorFactory1<? super TInput, ? extends TType> expression, 
	...
	public IAggregateExecutor<TInput, TOutput> create() {
		return new ExpressionExecutor<TInput, TType, TOutput>(expression.create(), factory.create());
	}
