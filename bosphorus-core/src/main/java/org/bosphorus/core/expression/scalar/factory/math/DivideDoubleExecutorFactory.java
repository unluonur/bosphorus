...
import org.bosphorus.core.expression.scalar.executor.math.DivideDoubleExecutor;
import org.bosphorus.core.expression.scalar.factory.IScalarExecutorFactory2;

public class DivideDoubleExecutorFactory implements IScalarExecutorFactory2<Number, Number, Double> {
	private static DivideDoubleExecutor instance = new DivideDoubleExecutor();
