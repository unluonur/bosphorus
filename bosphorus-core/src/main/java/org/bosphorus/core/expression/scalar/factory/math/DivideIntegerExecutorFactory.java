...
import org.bosphorus.core.expression.scalar.executor.math.DivideIntegerExecutor;
import org.bosphorus.core.expression.scalar.factory.IScalarExecutorFactory2;

public class DivideIntegerExecutorFactory implements IScalarExecutorFactory2<Number, Number, Integer> {
	private static DivideIntegerExecutor instance = new DivideIntegerExecutor();
