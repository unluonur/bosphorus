...
import org.bosphorus.core.expression.aggregate.executor.common.ListExpressionExecutor;
...
public class ListExpressionFactory<TInput, TType, TOutput> implements IAggregateExecutorFactory<TInput, TOutput> {
	...
	private IScalarExecutorFactory1<? super TInput, ? extends List<? extends TType>> expression;
	private IAggregateExecutorFactory<? super TType, ? extends TOutput> factory;
	
	public ListExpressionFactory(IScalarExecutorFactory1<? super TInput, ? extends List<? extends TType>> expression, 
	...
	public IAggregateExecutor<TInput, TOutput> create() {
		return new ListExpressionExecutor<TInput, TType, TOutput>(expression.create(), factory.create());
	}
