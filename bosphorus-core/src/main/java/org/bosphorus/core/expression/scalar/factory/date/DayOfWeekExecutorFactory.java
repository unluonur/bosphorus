...
import org.bosphorus.core.expression.scalar.executor.date.DayOfWeekExecutor;
import org.bosphorus.core.expression.scalar.factory.IScalarExecutorFactory1;

public class DayOfWeekExecutorFactory implements IScalarExecutorFactory1<Date, Integer> {
	private static DayOfWeekExecutor instance = new DayOfWeekExecutor();
