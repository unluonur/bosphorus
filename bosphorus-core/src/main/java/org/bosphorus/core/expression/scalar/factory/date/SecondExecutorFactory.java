...
import org.bosphorus.core.expression.scalar.executor.date.SecondExecutor;
import org.bosphorus.core.expression.scalar.factory.IScalarExecutorFactory1;

public class SecondExecutorFactory implements IScalarExecutorFactory1<Date, Integer> {
	private static SecondExecutor instance = new SecondExecutor();
