...
import org.bosphorus.core.expression.scalar.executor.date.TruncateToYearExecutor;
import org.bosphorus.core.expression.scalar.factory.IScalarExecutorFactory1;

public class TruncateToYearExecutorFactory implements IScalarExecutorFactory1<Date, Date> {
	private static TruncateToYearExecutor instance = new TruncateToYearExecutor();
