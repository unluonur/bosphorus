...
import org.bosphorus.core.expression.scalar.executor.event.ExpressionExecutor1;
...
public class ExpressionExecutorFactory1<TInput, TOutput, TType> implements IScalarExecutorFactory1<TInput, TOutput> {
	private IScalarExecutorFactory1<? super TType, ? extends TOutput> executor;
	private IScalarExecutorFactory1<? super TInput, ? extends TType> parameter;

	public ExpressionExecutorFactory1(
			IScalarExecutorFactory1<? super TType, ? extends TOutput> executor, 
			IScalarExecutorFactory1<? super TInput, ? extends TType> parameter) {
