...
import org.bosphorus.core.expression.scalar.executor.math.ModIntegerExecutor;
import org.bosphorus.core.expression.scalar.factory.IScalarExecutorFactory2;

public class ModIntegerExecutorFactory implements IScalarExecutorFactory2<Number, Number, Integer> {
	private static ModIntegerExecutor instance = new ModIntegerExecutor();
