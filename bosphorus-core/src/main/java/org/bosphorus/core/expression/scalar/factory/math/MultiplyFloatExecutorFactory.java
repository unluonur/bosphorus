...
import org.bosphorus.core.expression.scalar.executor.math.MultiplyFloatExecutor;
import org.bosphorus.core.expression.scalar.factory.IScalarExecutorFactory2;

public class MultiplyFloatExecutorFactory implements IScalarExecutorFactory2<Number, Number, Float> {
	private static MultiplyFloatExecutor instance = new MultiplyFloatExecutor();
