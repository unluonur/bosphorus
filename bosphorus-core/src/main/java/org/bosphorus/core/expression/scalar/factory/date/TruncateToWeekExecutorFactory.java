...
import org.bosphorus.core.expression.scalar.executor.date.TruncateToWeekExecutor;
import org.bosphorus.core.expression.scalar.factory.IScalarExecutorFactory1;

public class TruncateToWeekExecutorFactory implements IScalarExecutorFactory1<Date, Date> {
	private static TruncateToWeekExecutor instance = new TruncateToWeekExecutor();
