...
import org.bosphorus.core.expression.scalar.executor.date.TruncateToHourExecutor;
import org.bosphorus.core.expression.scalar.factory.IScalarExecutorFactory1;

public class TruncateToHourExecutorFactory implements IScalarExecutorFactory1<Date, Date> {
	private static TruncateToHourExecutor instance = new TruncateToHourExecutor();
