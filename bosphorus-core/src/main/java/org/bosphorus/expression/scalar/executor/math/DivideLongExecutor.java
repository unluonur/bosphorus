...
public class DivideLongExecutor<TInput> implements IScalarExecutor<TInput, Long> {

	private IScalarExecutor<? super TInput, ? extends Number> left;
	private IScalarExecutor<? super TInput, ? extends Number> right;

	public DivideLongExecutor(IScalarExecutor<? super TInput, ? extends Number> left,
