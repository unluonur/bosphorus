...
public class ModIntegerExecutor<TInput> implements IScalarExecutor<TInput, Integer> {

	private IScalarExecutor<? super TInput, ? extends Number> left;
	private IScalarExecutor<? super TInput, ? extends Number> right;

	public ModIntegerExecutor(IScalarExecutor<? super TInput, ? extends Number> left,
