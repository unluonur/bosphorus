...
public class DivideDoubleExecutor<TInput> implements IScalarExecutor<TInput, Double> {

	private IScalarExecutor<? super TInput, ? extends Number> left;
	private IScalarExecutor<? super TInput, ? extends Number> right;

	public DivideDoubleExecutor(IScalarExecutor<? super TInput, ? extends Number> left,
