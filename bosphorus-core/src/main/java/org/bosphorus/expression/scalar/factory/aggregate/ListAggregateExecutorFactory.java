...
package org.bosphorus.expression.scalar.factory.aggregate;
...
public class ListAggregateExecutorFactory<TInput, TType, TOutput> implements IScalarExecutorFactory1<TInput, TOutput> {
	...
	public ListAggregateExecutorFactory(IScalarExecutor1<? super TInput, ? extends List<? extends TType>> listExpression, 
	...
	public IScalarExecutor1<TInput, TOutput> create() {
		return new ListAggregateExecutor<TInput, TType, TOutput>(listExpression, factory);
	}
