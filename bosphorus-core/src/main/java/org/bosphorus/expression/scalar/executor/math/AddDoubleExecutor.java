...
public class AddDoubleExecutor<TInput> implements IScalarExecutor<TInput, Double> {

	private IScalarExecutor<? super TInput, ? extends Number> left;
	private IScalarExecutor<? super TInput, ? extends Number> right;
	
	public AddDoubleExecutor(IScalarExecutor<? super TInput, ? extends Number> left,
