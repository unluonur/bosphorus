...
public class DivideIntegerExecutor<TInput> implements IScalarExecutor<TInput, Integer> {

	private IScalarExecutor<? super TInput, ? extends Number> left;
	private IScalarExecutor<? super TInput, ? extends Number> right;

	public DivideIntegerExecutor(IScalarExecutor<? super TInput, ? extends Number> left,
