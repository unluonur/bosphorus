...
public class TruncateToMonthExecutor<TInput> implements IScalarExecutor<TInput, Date> {
	private IScalarExecutor<? super TInput, Date> expression;
	
	public TruncateToMonthExecutor(IScalarExecutor<? super TInput, Date> expression) {
