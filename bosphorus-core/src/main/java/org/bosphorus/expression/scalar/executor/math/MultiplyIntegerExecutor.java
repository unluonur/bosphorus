...
public class MultiplyIntegerExecutor<TInput> implements IScalarExecutor<TInput, Integer> {

	private IScalarExecutor<? super TInput, ? extends Number> left;
	private IScalarExecutor<? super TInput, ? extends Number> right;

	public MultiplyIntegerExecutor(IScalarExecutor<? super TInput, ? extends Number> left,
