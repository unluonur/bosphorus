...
public class MultiplyDoubleExecutor<TInput> implements IScalarExecutor<TInput, Double> {

	private IScalarExecutor<? super TInput, ? extends Number> left;
	private IScalarExecutor<? super TInput, ? extends Number> right;

	public MultiplyDoubleExecutor(IScalarExecutor<? super TInput, ? extends Number> left,
