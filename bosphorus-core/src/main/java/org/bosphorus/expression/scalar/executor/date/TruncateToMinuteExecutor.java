...
public class TruncateToMinuteExecutor<TInput> implements IScalarExecutor<TInput, Date> {
	private IScalarExecutor<? super TInput, Date> expression;
	
	public TruncateToMinuteExecutor(IScalarExecutor<? super TInput, Date> expression) {
