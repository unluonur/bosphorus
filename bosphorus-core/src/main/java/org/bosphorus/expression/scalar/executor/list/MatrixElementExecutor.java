...
public class MatrixElementExecutor<TInput extends List<? extends List<?>>, TOutput> implements IScalarExecutor<TInput, TOutput> {
	private Integer streamIndex;
	private Integer fieldIndex;
	
	public MatrixElementExecutor(Integer streamIndex, Integer fieldIndex) {
