...
public class MultiTupleField<TInput extends List<List<Object>>, TOutput> implements IExpression<TInput, TOutput> {
	private Integer streamIndex;
	private Integer fieldIndex;
	
	public MultiTupleField(Integer streamIndex, Integer fieldIndex) {
