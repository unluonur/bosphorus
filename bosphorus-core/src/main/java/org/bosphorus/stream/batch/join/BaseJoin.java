...
public abstract class BaseJoin<TInput> implements IReader<List<List<TInput>>> {
	...
	private IScalarExecutor1<List<TInput>, Boolean> expression;
	
	public BaseJoin(IReader<List<List<TInput>>> left, IReader<List<TInput>> right, IScalarExecutor1<List<TInput>, Boolean> expression) {
		this.setLeft(left);
		this.setRight(right);
	...
	public IScalarExecutor1<List<TInput>, Boolean> getExpression() {
		return expression;
	}

	public void setExpression(IScalarExecutor1<List<TInput>, Boolean> expression) {
